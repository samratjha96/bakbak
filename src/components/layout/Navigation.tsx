          ...
          <div className="flex justify-between md:justify-start overflow-x-auto no-scrollbar">
            {navItems.map((item) => (
              <Link
                ...
                activeProps={{ 
                  className: 'flex items-center gap-2 px-3 sm:px-4 lg:px-8 py-3 font-medium border-b-2 border-primary text-primary transition-colors whitespace-nowrap flex-1 md:flex-none text-center md:text-left' 
                }}
              >
                <span className="mx-auto md:mx-0 md:mr-2">{item.icon}</span>
