          ...
          <div className="grid grid-cols-3 gap-x-12 text-xs">
            <div>
              ...
              <ul className="flex flex-col space-y-1 mt-2 text-gray-500">
                <li><Link to="/" className="hover:text-primary">Voice Recording</Link></li>
                <li><Link to="/" className="hover:text-primary">AI Transcription</Link></li>
                <li><Link to="/" className="hover:text-primary">Romanization</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="flex flex-col space-y-1 mt-2 text-gray-500">
                <li><Link to="/" className="hover:text-primary">Japanese</Link></li>
                <li><Link to="/" className="hover:text-primary">Korean</Link></li>
                <li><Link to="/" className="hover:text-primary">Mandarin</Link></li>
                <li><Link to="/" className="hover:text-primary">Spanish</Link></li>
              </ul>
            </div>
          ...
          <div className="flex flex-col space-y-4 py-2">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-1">
                <span className="text-primary text-sm font-semibold">BakBak</span>
                <span className="text-xs text-gray-500">&copy; {currentYear}</span>
              </div>
