...
const RecordingItem: React.FC<RecordingItemProps> = ({ title, language, duration, date, onClick }) => (
  <div 
...
const DashboardSidebar: React.FC<{activities: {id: string; text: string; time: string}[]}> = ({ activities }) => {
  return (
